...
//Gv88LKWZ2j8
//AIzaSyDvRTOsrJ1-_KFnaMGnBwHO6l1G6L7U-LI
          ...
          child: Column(
            children: [
              YoutubePlayer(
                ...
                progressColors: ProgressBarColors(handleColor: Colors.red , playedColor: Colors.red),
              ),
            ],
          ),
        ));
...
class MyApp extends StatelessWidget {
  final String videoId = 'Gv88LKWZ2j8';
  final String apiKey = 'AIzaSyDvRTOsrJ1-_KFnaMGnBwHO6l1G6L7U-LI';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> fetchVideoDetails() async {
    ...
    try {
      var authClient = await clientViaApiKey('AIzaSyDvRTOsrJ1-_KFnaMGnBwHO6l1G6L7U-LI');
      var youtubeApi = youtube.YouTubeApi(authClient);

      var response = await youtubeApi.videos.list(
        ['snippet'],
        //id: videoId,
      );
      ...
      body: Center(
        child: video != null
          ...
          children: [
            ...
            Text('Channel Title: ${video.snippet?.channelTitle}'),
...
/// API - 2 = AIzaSyA8Vl0_Uz1D8CYNH_WXZQAXkp4ob1e1NPY
/// API - 1 = AIzaSyDvRTOsrJ1-_KFnaMGnBwHO6l1G6L7U-LI
  @override
